...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \centering
    {\Huge \textbf{\textcolor{black}{MongoDB: modello documentale,\\[0.4cm] aggregation, indici e teorema CAP}}}\footnote{Code repository: \url{https://github.com/ManuelTestoni/BigData/tree/main/Fitness_Exercise_Analysis} --- cartella \texttt{Fitness\_Exercise\_Analysis}}\\[0.6cm]
    {\large \textcolor{unimoregrey}{Una sperimentazione su un replica set a 3 nodi}}\\[1.4cm]
    \textsc{\LARGE Approfondimento sui sistemi NoSQL}\\[0.5cm]
    \text{\large Big Data Analytics}\\[2cm]

    {\Large \textbf{\textcolor{unimorered}{Autore:}}}\\[0.5cm]
    \begin{tabular}{c}
        \Large \textcolor{unimoregrey}{Manuel Testoni (219155)} \\
    \end{tabular}\\[2cm]
