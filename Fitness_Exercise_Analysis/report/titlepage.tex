...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \centering
    {\Huge \textbf{\textcolor{black}{MongoDB: modello documentale,\\[0.4cm] aggregation, indici e teorema CAP}}}\footnote{Code repository: \url{https://github.com/ManuelTestoni/BigData} --- cartella \texttt{Fitness\_Exercise\_Analysis}}\\[0.6cm]
